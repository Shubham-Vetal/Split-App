...
              <XAxis dataKey="month" />
              <YAxis tickFormatter={(value) => `₹${value}`} /> {/* Changed here */}
              <Tooltip formatter={(value) => [`₹${value}`, 'Amount']} /> {/* Changed here */}
              <Legend />
...
                ))}
              </Pie>
              <Tooltip formatter={(value) => [`₹${value.toFixed(2)}`, 'Amount']} /> {/* Changed here */}
              <Legend />
            </PieChart>
          </ResponsiveContainer>
        ) : (
...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">₹{transaction.amount}</td> {/* Changed here */}
